...
CREATE TABLE IF NOT EXISTS user_history (
    user_history_id integer PRIMARY KEY AUTOINCREMENT,
    user_id integer,
    email text not null,
    preferred_name text not null,
    last_edited_by integer not null,
...
CREATE TABLE IF NOT EXISTS migration_history (
    migration_history_id integer PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS document_history (
    document_history_id integer PRIMARY KEY AUTOINCREMENT,
    document_id integer,
    title text not null,
    filename text not null,
    data blob null,
...
CREATE TABLE IF NOT EXISTS keyword_history (
    keyword_history_id integer PRIMARY KEY AUTOINCREMENT,
    keyword_id integer,
    name text not null,
    last_edited_by integer not null,
    row_version integer,
...
CREATE TABLE IF NOT EXISTS document_keyword_history (
    document_keyword_history_id integer PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS document_suggestion_history (
    document_suggestion_history_id integer PRIMARY KEY AUTOINCREMENT,
...
BEGIN
    ...
    SELECT 
        OLD.migration_id, OLD.version, OLD.description, OLD.last_edited_by, OLD.row_version, OLD.valid_from, strftime('%Y-%m-%d %H:%M:%f', 'now');
